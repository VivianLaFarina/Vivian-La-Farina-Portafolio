...
import CV from "../assets/VLF-CV.pdf";

const About = () => {
  return (
    <main>
      <Header />
      <section className=' px-2 md:px-10 text-zinc-400 md:grid md:grid-cols-[1fr_2fr] md:min-h-[500px] max-w-[1200px] mx-auto'>
      ...
      <section className='grid grid-rows-2 px-2 py-4 md:grid-cols-2  md:px-3  text-slate-600'>
        ...
        <button className='text-xl flex justify-center items-center gap-2'>
          <i className='bx bxs-right-arrow  md:text-4xl '></i>
