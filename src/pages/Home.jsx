...
const Home = () => {
    ...
    return (
        <section className='min-h-screen'>
            ...
            <main className='text-slate-600 px-6 py-8 md:px-10 md:py-4 flex flex-col items-center justify-center'>
                <article className='space-y-4 text-center font-medium'>
                    ...
                    <h2 className='text-3xl md:text-5xl lg:text-6xl font-extrabold'>
                        Hey, I'm
                        <p className='text-5xl md:text-6xl lg:text-8xl py-4'>Vivian La Farina</p>
                    </h2>
